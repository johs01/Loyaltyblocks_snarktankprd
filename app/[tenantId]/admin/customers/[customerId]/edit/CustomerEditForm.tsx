 ...
 *
 * Client component for editing customer information with validation
 */
...
export default function CustomerEditForm({
  ...
  const [formData, setFormData] = useState({
    ...
    birthDate: customer.birthDate, // string from props
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`/api/${tenantId}/customers/${customer.id}`, {
        method: "PUT",
        headers: {
      ...
      router.push(`/${tenantId}/admin/customers/${customer.id}`);
      router.refresh();
    } catch (error) {
